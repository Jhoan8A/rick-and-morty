...
import { fetchCharactersGraphQL } from "../services/characters";
...
export const CharacterList = (props) => {
  ...
  const loadCharacters = async () => {
    ...
    try {
      //const data = await fetchCharacters(); // if you want get characters for api rest
      const data = await fetchCharactersGraphQL();// get characters for graphql
      console.log("CHARACTERS DE GRAPHQL...", data);
      setCharacters(data.characters);//response get result graph ql
      //setCharacters(data.results);// response get result api rest
      console.log("CHARACTERS DE result...", data.characters);
    } catch (error) {
  ...
  console.log("CHARACTERS GET TO FILTER...", characters)
